...
//table
             ps=con.prepareStatement("select * from sent where too=?");
            ...
            { 
                ...
                String too=rs.getString(2);
                String sub=rs.getString(4);
                String smsg=rs.getString(5);
            out.println("<tr><td><input type=\"checkbox\" name=\"ck\" value=\""+id+"\">"+too+"</td><td><a href='message?msg="+smsg+"'>"+sub+"</a></td></tr>");
